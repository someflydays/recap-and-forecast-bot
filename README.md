...
iThis application searches the internet for information about the user's specified topic. Based on the search results, a report is generated that either summarizes the topic's recent events or speculates about potential future events.
